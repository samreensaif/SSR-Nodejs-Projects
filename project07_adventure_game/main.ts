...
knockoutpunch()             //knock-out punch function, at once the player won/lost
{
this.fuel=0;
}
}
...
knockoutpunch()             //knock-out punch function, at once the opponent won/lost
{
...
console.log(
chalk.blueBright.bold.italic('\t\t🎲🎲🎲 WELCOME TO SSR-CLI-ADVENTURE GAME🎲🎲🎲\t\t ')); 
