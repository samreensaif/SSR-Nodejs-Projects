...
class PatientsInfo {
    ...
    pContactNo;
    pMrNo;
    constructor(name, gender, age, contactNo, mrNo) {
        this.pName = name;
        this.pGender = gender;
        this.pAge = age;
...
function newDate(dateTime, dayname) {
...
let patient = new PatientsInfo(name, createPatientData.p_gender, createPatientData.p_age, createPatientData.p_contactNumber, pmrNo);
...
let docName = consultants[docKey];
